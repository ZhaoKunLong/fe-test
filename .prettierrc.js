 ...
 * @LastEditTime: 2023-02-09 18:17:17
 * @FilePath: \demo-hs\.prettierrc.js
 * @Description: 文件说明
...
module.exports = {
  ...
  trailingComma: 'all', // 在对象或数组最后一个元素后面是否加逗号（在ES5中加尾逗号）none
  tslintIntegration: false, // 不让prettier使用tslint的代码格式进行校验
  embeddedLanguageFormatting: 'auto', // 对引号中代码使用智能格式化
  singleAttributePerLine: false //如果HTML元素（包括JSX等）具有多个属性，将其每个属性西方式化为单独一行
};
